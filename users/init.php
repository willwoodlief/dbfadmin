...
//put it here.
$db_table_prefix = "app_";  //not used anywhere
$copyright_message = 'Reanac';
...
if(Cookie::exists(Config::get('remember/cookie_name')) && !Session::exists(Config::get('session/session_name'))){
	...
	$hashCheck = DB::getInstance()->query("SELECT * FROM app_users_session WHERE hash = ? AND uagent = ?",array($hash,Session::uagent_no_version()));
