...
$query = $db->query("SELECT * FROM app_email");
$results = $query->first();
				...
				<?php if($user->isLoggedIn()){ //anyone is logged in?>
                  ...
                  <!--  <li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>"><i class="fa fa-fw fa-home"></i> &^ Home</a></li> --> <!-- Hamburger menu link -->
                    ...
                    <?php if (in_array("Administrator", $user->roles())) { ?>
                        <li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>pages/upload.php"><i class="fa fa-fw fa-dashboard"></i> Status </a></li> <!-- Common for Hamburger and Regular menus link -->
                    <?php } ?>
